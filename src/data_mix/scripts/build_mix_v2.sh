...
CONFIG="${CONFIG:-${DATA_MIX_DIR}/configs/mix-50k-v2.yaml}"
...
echo "== data_mix v2 build =="
echo "HF_HOME              = ${HF_HOME:-<unset, using huggingface_hub default>}"
echo "TRAILOGY_DATA_ROOT   = ${DATA_ROOT}"
echo "DATA_MIX_OUTPUT_ROOT = ${DATA_MIX_OUTPUT_ROOT:-<unset, default <data_root>/mix-50k-v2/>}"
echo "CONFIG               = ${CONFIG}"
